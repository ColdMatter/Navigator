...
namespace MOTMaster2.SequenceData
{
    ...
    public class sw7 : EqCompiler.CFunction
    {
        ...
        public override double GetValue()
        {
            ...
            return sw7func(oValue0.GetValue(), oValue1.GetValue(), oValue2.GetValue(), oValue3.GetValue(), oValue4.GetValue(), oValue5.GetValue(), oValue6.GetValue(), oValue7.GetValue());
        }
    ...
    public class sw8 : EqCompiler.CFunction
    {
        ...
        public override double GetValue()
        {
            ...
            return sw8func(oValue0.GetValue(), oValue1.GetValue(), oValue2.GetValue(), oValue3.GetValue(), oValue4.GetValue(),
                oValue5.GetValue(), oValue6.GetValue(), oValue7.GetValue(), oValue8.GetValue());
        }
