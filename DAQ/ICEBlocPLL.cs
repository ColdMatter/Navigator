...
namespace DAQ.HAL
{
    public class ICEBlocPLL : ICEBlocRemote
    {
        ...
        public bool configure_PLL_profile(double PLLFreq, double chirp_rate, double chirp_duration)
        {
            return configure_lo_profile(true, false, "ecd", PLLFreq, 0.0, chirp_rate, chirp_duration, false);
        }
        ...
        public object CommandTest(int index)
        {
            ...
            switch (index)
            {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    result = configure_lo_profile(true, false, "ecd", 6834648621.0, 0.0, 500000.0, 0.5, false);
                    break;
                case 9:
