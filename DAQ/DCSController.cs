...
namespace DAQ.HAL
{
    ...
    public class DCSController : ICEBLOCCommunicator
    {
        ...
        public ICEBLOCMessage SendMessage(ICEBLOCMessage message)
        {
            ...
            ICEBLOCMessage rslt = null;
            try
            {
                rslt = JsonConvert.DeserializeObject<ICEBLOCMessage>(jsonreply);
            }
            catch (Exception e)
            {
                Console.WriteLine("Error in line:81 -> " + e.Message);
        ...
        public void StartLink()
        {
            ...
            parameters["ip_address"] = "192.168.1.233";
